...
async def chat(req: Request):
    ...
    # 🔒 SAME PROMPT CONTRACT AS OLLAMA VERSION
    prompt = f"""
...
"""
    ...
    def stream():
        ...
        # ⚠️ EXACT SAME STREAMING STYLE AS OLLAMA
